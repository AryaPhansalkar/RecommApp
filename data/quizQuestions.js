export const quizQuestions = [
...

  {
    ...
    options: [
      { label: "Solving a clever problem", scores: { "Puzzle": 20, "Strategy": 10 } },
      { label: "Reacting quickly to things happening", scores: { "Action": 25 } },
      { label: "Exploring a world at my own pace", scores: { "Adventure": 25 } },
      { label: "Building or managing something", scores: { "Simulation": 20, "Strategy": 10 } }
    ]
  },
  ...
  {
    id: 4,
    question: "If you fail at something, what do you prefer?",
    options: [
...

  {
    ...
    options: [
      { label: "Watching or reading stories", scores: { "Adventure": 20, "Role-Playing": 10 } },
      { label: "Playing a sport or being active", scores: { "Action": 25 } },
      { label: "Solving puzzles or riddles", scores: { "Puzzle": 25 } },
      { label: "Organizing or building things", scores: { "Simulation": 20, "Strategy": 10 } }
    ]
  },

  {
    id: 7,
    question: "How do you feel about time pressure?",
    options: [
...

  {
    ...
    options: [
      { label: "Becoming stronger over time", scores: { "Role-Playing": 25 } },
      { label: "Finishing short satisfying tasks", scores: { "Casual": 20 } },
      { label: "Mastering a complex system", scores: { "Strategy": 25 } },
      { label: "Exploring and discovering things", scores: { "Adventure": 25 } }
    ]
  },

  {
    id: 9,
    question: "What kind of difficulty do you prefer?",
    options: [
      { label: "Easy and relaxing", scores: { "Casual": 25 } },
      { label: "Medium and fair", scores: { "Adventure": 15, "Role-Playing": 10 } },
      { label: "Hard but skill-based", scores: { "Action": 25 } },
      { label: "Hard but thinking-based", scores: { "Strategy": 25, "Puzzle": 10 } }
    ]
  },
